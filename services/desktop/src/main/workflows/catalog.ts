...
const NOT_ALLOWED_RE =
  /^(ask_user_|tool_search$|tool_load$|skill_|chat_history_|workflow_|connect_|disconnect_|settings_set_key|.*_key(_|$)|telegram_(connect|disconnect|token)|voice_|updater_|producer_|ollama_(pull|delete)|org_(join|leave|create|member_)|profile_reset|report_self_correction$|memory_)/;
...
export const LOGIC_NODES: WorkflowCatalogEntry[] = [
  ...
  { type: "wait", label: "Warten", category: "Ablauf", summary: "Wartet eine Zeitspanne (max 7 Tage).", parameters: { type: "object", properties: { minutes: { type: "number", minimum: 1, maximum: 10080 } } }, write: false, actionKind: "read", costClass: "frei" },
