...
export const LOGIC_NODES: WorkflowCatalogEntry[] = [
  ...
  { type: "wait", label: "Warten", category: "Ablauf", summary: "Wartet eine Zeitspanne (max 7 Tage) ODER bis ein Vorgang (Import) fuer alle Firmen abgeschlossen ist (Watcher).", parameters: { type: "object", properties: { minutes: { type: "number", minimum: 1, maximum: 10080 }, transactionId: { type: "string", description: "Vorgangs-ID, z. B. {{ $json.transactionId }} aus discovery_decide/import — wartet bis alle Firmen verarbeitet sind" }, maxHours: { type: "number", default: 6 } } }, write: false, actionKind: "read", costClass: "frei" },
