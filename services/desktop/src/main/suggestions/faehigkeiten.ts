...
export const FAEHIGKEITEN: Faehigkeit[] = [
  ...
  { id: "email_ableitung", text: "E-Mail-Adressen nach dem Adressmuster der Firma ableiten und beim Mail-Server pruefen (Hintergrund, Verlauf, Vorschau)", tools: ["email_muster_*"], feature: "kontakte" },
  { id: "import", text: "Excel-Listen oder CRM-Firmen importieren und anreichern; Importstand, Fehler, Wiederholung je Schritt", tools: ["import_*", "resolve_import_matches", "retry_stage", "transactions_list", "transaction_get", "transaction_entities", "transaction_errors", "transaction_pipeline"] },
  ...
  { id: "best_match", text: "Passendste Firmen aus dem Bestand zu einer Anfrage ranken (Best-Match, Vergleich, Angebotsanalyse)", tools: ["evaluation_*"] },
  { id: "icp", text: "Idealkundenprofil (ICP) festlegen, aus Website-URLs ableiten oder anpassen", tools: ["icp_*"] },
  { id: "radar", text: "Firmen-Radar: Regionen-Scan, Kandidaten mit Mini-Profil und ICP-Score ansehen, importieren oder verwerfen, Automatik, Deckel, Live-Stand", tools: ["discovery_*", "radar_config", "radar_activity", "geo_places_nearby"] },
  ...
  { id: "hubspot", text: "HubSpot verbinden: Firmen, Kontakte, Deals, Aufgaben, Notizen lesen, anlegen, aktualisieren; AVA-Firmen mit HubSpot verknuepfen", tools: ["crm_*", "connect_crm", "disconnect_crm"] },
  ...
  { id: "relevanz", text: "Relevanz: Naehe zu Firma oder Person (1-10), Beobachtungsvorschau, was im Team Thema ist, Erfassung an/aus/loeschen", tools: ["relevanz_*"], feature: "relevanz" },
  ...
  { id: "workflows", text: "Workflows: Ablaeufe speichern, per Zeitplan oder Ereignis ausfuehren, Freigaben, Vorlagen, Laufhistorie", tools: ["workflow_*"], feature: "workflows" },
