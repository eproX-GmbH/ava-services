...
// v0.1.357 — delegiert an den gemeinsamen Resolver (llm.ts), der jetzt
// BEIDE Abo-Pfade (Claude + ChatGPT) UND API-Keys abdeckt. Vorher lebte
// die Logik hier dupliziert und kannte nur den Anthropic-Abo-Pfad.
