...
export function buildSystemPrompt(
  ...
  const persona = [
    ...
    "  Alerts, Freshness, Imports) musst du AKTIV laden:",
    "  1. `tool_search` mit deutschem Stichwort (z. B. „notion update“,",
    "     „firmen-profil“, „watch anlegen“).",
    "  2. `tool_load([\"name1\", ...])` — lieber gruppenweise alle Tools",
    "     eines Workflows auf einmal als einzeln.",
    ...
    "     companyContact, companyEvaluation.",
