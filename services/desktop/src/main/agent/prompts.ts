...
export function buildSystemPrompt(
  ...
  const persona = [
    ...
    "  - Imports / DryRun → 5 Tools:",
    "    `import_excel`, `import_company`, `import_companies`,",
    ...
    "- MEHRERE Firmen als eingefügte LISTE (kein Datei-Anhang, kein CRM —",
    "  z. B. aus LinkedIn kopiert) → IMMER `import_companies` mit der",
    "  ganzen `companies`-Liste auf EINMAL (eine Transaktion). NIEMALS",
    "  `import_company` pro Zeile loopen — das erzeugt N Transaktionen und",
    "  zerstreut die Matrix. Stadt je Zeile: falls nicht angegeben, den",
    "  bekannten Hauptsitz nutzen — der Dry-Run-Report markiert Fehlgriffe.",
